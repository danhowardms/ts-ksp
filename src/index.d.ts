...
import { LambertSolution } from "./lambert";
...
export { CelestialBody, OrbitingCelestialBody, KerbolSystem, LambertSolution, Orbit, TransferType, findTransfer, Quaternion, addQQ, conjugateQ, normalizeQ, concatQQ, quaternionFromAngleAndAxis, quaternionFromStartAndEndVectors, vectorToQuaternion, quaternionToVector, rotate, newtonsMethod, brentsMethod, goldenSectionSearch, SlingshotOptions, findSlingshotRoute, TransferOptions, AngleDegrees, Vector3, addVV, subVV, mulVS, divVS, normSquaredV, normV, normalizeV, dotVV, crossVV, projectToPlane, angleBetween, signedAngleInPlaneBetween };
